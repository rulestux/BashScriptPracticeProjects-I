...
# parameter, sending messages to an email when the process is   #
# interrupted.                                                  #
#                                                               #
# Usage example:                                                #
...
do
    ...
    then
        ...
        # do contrário, enviar a mensagem de erro para o
        # email com o comando 'mail', aguardar 'sleep $TIME' e
        # tornar a verificar:
        echo "WARNING! Process $1 is not running!" | mail -s "[$0] monitoring $1" $EMAIL
        sleep $TIME
    fi
done
